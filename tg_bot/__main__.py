                    ...
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                ...
                                url="https://telegra.ph/Apa--Minta-Source-Fujiwara-Chika-Private-Kontol-05-16",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            help_buttons.append(
                [InlineKeyboardButton(text="Back", callback_data="help_back"),
                 InlineKeyboardButton(text='Support', url='https://t.me/isekaiproject')]
            )
